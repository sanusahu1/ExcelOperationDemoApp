...
namespace ExcelDemo
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var file = new FileInfo(@"C:\Log\Test.xlsx");
        ...
        private static List<PersonModel> GetSetupData()
        {
            List<PersonModel> output = new()
            {
                new() { Id = 1, FirstName = "Sanu", LastName = "Sahu" },
                new() { Id = 2, FirstName = "SmrutiRanjan", LastName = "Sahu" },
                new() { Id = 3, FirstName = "Subhashree", LastName = "Parida" }
            };
